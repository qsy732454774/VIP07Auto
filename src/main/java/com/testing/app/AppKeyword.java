...
import com.testing.webDriver.AppBrowserDriver;
...
public class AppKeyword {
	...
	/**
	 * 通过browserName启动浏览器的方法
	 * @param device
	 * @param version
	 */
	public void runBrowser(String device,String version,String appiumServerPort){
		try {
			AutoLogger.log.info("正在启动安卓浏览器");
			AppBrowserDriver appBro=new AppBrowserDriver(device,version,appiumServerPort);
	...
	public void visitURL(String url){
		try {
			...
			e.printStackTrace();
			AutoLogger.log.error(e,e.fillInStackTrace());
			AutoLogger.log.error("访问"+url+"失败");
		}
	}
